                    ...
                    <div class="card-body"> 
                        <div class="row">
                            ...
                            <div class="col-8 text-right">
                                <p class="text-muted font-14">Zones</p>
                                <h3 class="mb-0">{{ \domain\Facades\Zone\ZoneFacade::zoneCount() }}</h3>
                            </div><!-- end col-->
                        </div><!-- end row-->                                                                                  
                    </div><!--end card-body--> 
                </div><!--end card-->
                    ...
                    <div class="card-body"> 
                        <div class="row">
                            ...
                            <div class="col-8 text-right">
                                ...
                                <h3 class="mb-0">{{ \domain\Facades\User\UserFacade::userCount() }}</h3>                                            
                            </div><!-- end col-->
                        </div><!-- end row-->
                    </div><!--end card-body--> 
                </div><!--end card-->
                ...
                <div class="card crm-data-card">
                    <div class="card-body"> 
                        <div class="row">
                            ...
                            <div class="col-8 text-right">
                                <p class="text-muted font-14">Territories</p>
                                <h3 class="mb-0">{{ \domain\Facades\Territory\TerritoryFacade::territoryCount() }}</h3>                                            
                            </div><!-- end col-->
                        </div><!-- end row-->                                                                                     
                    </div><!--end card-body--> 
                </div><!--end card--> 
                ...
                <div class="card crm-data-card">                                        
                    <div class="card-body"> 
                        <div class="row">
                            ...
                            <div class="col-8 text-right">
                                <p class="text-muted font-14">Regions</p>
                                <h3 class="mb-0">{{ \domain\Facades\Region\RegionFacade::RegionCount() }}</h3>
