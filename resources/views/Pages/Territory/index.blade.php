...
@section('header')
    ...
    @include('Pages.Territory.Components.modal')
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <tbody>
                            @foreach ($teriitories as $value)
                                <tr>
                                    ...
                                    <td>{{ $value->code }}</td>
                                    <td>{{ $value->name }}</td>
                                    <td>{{ $value->zoneDate->code }}</td>
                                    <td>{{ $value->regionData->name }}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <button class="dropdown-item"
                                                    onclick="delconf('{{ route('territory.delete', $value->id) }}', 'Do you want to delete this Territory?')">
